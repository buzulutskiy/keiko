...
# Отсечка слева обязательна: без неё «показывают» ловилось как «оказыв»,
# и на «Одиссее» половина шума шла от одного этого слова.
СЛОВА = re.compile(
    r"(?<![а-яё])"
    r"(убива|убьёт|убил|погиб|умира|умрёт|умер(?!енн)|смерть его|в финале|в конце книги"
