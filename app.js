...
function gmCard() {
  ...
  /* Никакого поиска по названию: Google слишком охотно подменяет место
     созвучным заведением — «метеостанция Солнечная» превращается в институт
     солнечно-земной физики. Отдаём только координаты: булавка встаёт ровно
