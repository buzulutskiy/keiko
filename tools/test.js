   ...
   обещает «завтра закончишь». */
{
  ...
  ок("строка: возвращения, а не темп", t.get("paceDays")(), "3 дня с книгой");
  ...
  ок("строка: пропуск не отнимает уже прожитое", t.get("paceDays")(), "3 дня с книгой");
  ...
  ок("строка: вернулся после месяца — число выросло", t.get("paceDays")(), "4 дня с книгой");
...
/* ── Простой рисунок: день плюс снимок ── */
{
  ...
  ок("рисунок: дни на месте", /\d+ дн[а-я]* с рисунком/.test(рис), true);
  ок("рисунок: своё слово, а не «с книгой»", /с рисунком/.test(рис), true);
