   ...
   инструментом — единственное место, где двадцать минут и час отличаются. */
{
  ...
  /* Короткий заход — это занятие, но вещей не приносит: иначе «сел на минуту»
     и «просидел час» стоили бы одинаково. */
  ок("порция: меньше четверти часа — ничего", t.get("colПорция")(мат, 9), 0);
  ок("порция: обычное занятие — одна", t.get("colПорция")(мат, 20), 1);
  ок("порция: долгое — две", t.get("colПорция")(мат, 55), 2);
  ...
  ок("порция: у рисунка две за занятие", t.get("colПорция")(t.get("colMat")(), 5), 2);
...
/* ── Шапка карты: что показывать на какой вкладке ── */
{
  ...
  t.get("gm").слой = "read";
  t.get("gmNavRow")();
  ок("шапка: у текста глава тоже своя", ряд.hidden, false);
