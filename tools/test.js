...
/* ── Мягкий ориентир у пьесы: минуты недели ── */
{
  ...
  /* Набрал за неделю — ориентир молчит, догонять нечего. Считаем вместе с
     сегодняшним: отыграл всё в понедельник — молчит сразу. */
  t.get("data").piano.entries=[{ id: "p1", date: сег, pieceId: "bwv853", mins: 160 }];
  const п2=t.get("pianoWeekPlan")();
  ок("минуты: набранная неделя не требует ничего", [п2.набрано, п2.надо], [true, 0]);
